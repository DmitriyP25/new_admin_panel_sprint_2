"""Generated by Django 4.2.5 on 2023-12-04 15:45."""
...
class Migration(migrations.Migration):
    """All initial migrations for database creation."""
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_date', models.CharField(max_length=50, verbose_name='creation date')),
                ...
                ('type', models.CharField(choices=[('MV', 'movie'), ('TS', 'tv show')], default='MV', max_length=2)),
            ],
            options={
